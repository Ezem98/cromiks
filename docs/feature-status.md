...
| Pendientes bloqueantes para soft-beta | Cutover a prod (activar `francia`, seed/push, reset cuentas) + dominio. (Contenido de `francia` ✅ curado; sobre 3D ✅ re-texturizado.) |
...
| 4.17 | Critique de calidad del álbum | 🟢 | `/impeccable critique` → **29 → 31/40** (re-run 2026-06-04). **✅: Tanda 1 (T-13 + U-09 + U-12), T-12 (`AlbumSpotlight`, PR #50), T-10 (PR #51), T-08 (detalle apaisado, PR #52), U-17 (LCP/eager, PR #53), T-14 (smoke determinístico).** ✅ leyenda/ayuda, búsqueda+filtros-URL (+ T-10 restaurado), T-15 (reveal apaisado: summary + lite). **Backlog del critique CERRADO** (queda solo contenido/infra de beta, no del critique). Ver [`features/e1-album.md`](./features/e1-album.md#critique-2026-06-03-live-29-40) |
