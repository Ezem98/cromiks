...
| P2 | Filter bar = muro de 9 controles, domina el fold mobile (238px/28%) | T-10 (re-confirmado live) | ✅ 2026-06-04 (PR #51, toggle "Filtrar" mobile) |
...
**Plan acordado (2026-06-03):** ✅ **Tanda 1 (2026-06-04, PR #48)** = T-13 + U-09 + U-12. ✅ **T-12 (PR #50)** = `AlbumSpotlight`. ✅ **T-10 (PR #51)** = filter bar colapsable en mobile. **Pendientes del critique:** U-17 (LCP/lazy en la primera fila) + T-08 (detalle apaisado, P1 aparte). Todo verificado en vivo + type-check + lint + 21 tests.
