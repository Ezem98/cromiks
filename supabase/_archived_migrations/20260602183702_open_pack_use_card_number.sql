-- =============================================================================
-- Fix: open_pack devolvía 0 como número de cromo
-- =============================================================================
-- El RPC leía el número de `(c.metadata->>'number')::int`, pero el número
-- canónico del cromo vive en la columna `cards.card_number`. metadata->>'number'
-- está casi siempre vacío → NULL → el cliente lo bajaba a `?? 0` y mostraba "0"
-- en la esquina de la carta al abrir el sobre (el álbum se veía bien porque usa
-- card_number directo). Cambiamos la fuente a c.card_number.
--
-- Cuerpo idéntico a 20260601120000_open_pack_drop_image_url.sql salvo:
--   out_card_number: (c.metadata->>'number')::int  →  c.card_number
-- =============================================================================
